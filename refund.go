...
func (this *WechatPay) Refund(param OrderRefund) (*OrderRefundResult, error) {
	...
	if err != nil {
		log.Println(err.Error(), "xml marshal failed")
		return nil, err
	}
	...
	if err != nil {
		log.Println( "new http request failed,err :"+err.Error())
		return nil, err
	}
	...
	if _err != nil {
		log.Println("http request failed! err :"+_err.Error())
		return nil, err
	}
...
func (this *WechatPay) RefundQuery(refund_status OrderRefundQuery) (*OrderRefundQueryResult, error) {
	...
	if err != nil {
		log.Println( "xml marshal failed,err:"+err.Error())
		return nil, err
	}
